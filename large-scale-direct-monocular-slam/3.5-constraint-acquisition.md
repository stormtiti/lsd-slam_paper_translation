...
For this, we propose a novel method to perform $$\text{direct, scale-drift aware image alignment on } \mathfrak{sim}(3)$$ , which is used to align two differently scaled keyframes.
