...
After a new keyframe ![](/assets/math_38.png) is added to the map, a number of possible loop closure keyframes ![](/assets/math_66.png) is collected:

**当新的一帧关键帧** ![](/assets/math_38.png) **添加地图之后，进行闭环检测，即收集可能是（形成）闭环的（候选）关键帧 **![](/assets/math_66.png) 。 
