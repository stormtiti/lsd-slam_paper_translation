...
where the photometric residual ![](/assets/math_60.png)

and ![](/assets/math_61.png) is defined as in \(13\) - \(14\).
...
The depth residual and its variance is computed as![](/assets/equation_18.png) denotes the transformed point.
